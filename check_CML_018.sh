VCF_GZ_FILE=/work1/hsiaoyi0504/result/CML_hg19_2/TW-CML-M-018/Mutect2.vcf.gz
...
zcat $VCF_GZ_FILE | grep -P "chr19\t46511501"
zcat $VCF_GZ_FILE | grep -P "chr20\t18462374"
